...
public class AdapterPahlawan extends RecyclerView.Adapter<AdapterPahlawan.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        btndetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, IntenActivity.class);
    ...
    public ArrayList<com.example.tpmpertemuan42.modelPahlawan> getModelPahlawan() {
        return modelPahlawan;
    }

    public void setModelPahlawan(ArrayList<com.example.tpmpertemuan42.modelPahlawan> modelPahlawan) {
